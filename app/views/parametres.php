   ...
   <form action=<?php echo'?p=param' ;?> method="post">
     ...
     <h4 class="col-md-12 " style ="border-top-left-radius:15px; border-top-right-radius:15px;background-color:#A7E8A7;padding-bottom:5px;font-size:20px;text-align: center;">Paramétres généraux </h4>
       ...
       <div class="form-group centrage col-md-3">
         ...
         <input type="text" class="form-control formu1" id="inputrs" name="raisonsocial" value="<?php echo $this->array[0]->raisonsocial?>"  >
       </div>
       <div class="form-group centrage col-md-3">
         <label for="inputspec">Spécialité</label>
         <input type="text" class="form-control formu1" id="inputspec" name="specialite" value="<?php echo $this->array[0]->specialite?>">
       </div>
       <div class="form-group centrage col-md-3">
         <label for="inputweb">Site web</label>
         <input type="text" class="form-control formu1" id="inputweb" name="siteweb" value="<?php echo $this->array[0]->siteweb?>">
       </div>
       <div class="form-group centrage col-md-3">
         <label for="inputgerant">Gérant</label>
         <input type="text" class="form-control formu1" id="inputgerant" name="gerant" value="<?php echo $this->array[0]->gerant?>">
       </div>
       <div class="form-group centrage col-md-3">
         <label for="inputrc">Numéro RC</label>
         <input type="number" class="form-control formu1" id="inputrc" name="rc" value="<?php echo $this->array[0]->rc?>">
       </div>
       <div class="form-group centrage col-md-3">
         <label for="inputfisc"> identifiant fiscal</label>
         <input type="text" class="form-control formu1" id="inpufisc" name="idfisc" value="<?php echo $this->array[0]->idfisc?>">
       </div>
     </div>
     <div class="form-row fform">
       ...
       <div class="form-group centrage col-md-3">
         ...
         <input type="tel" class="form-control formu1" id="inputphone" name="tel" value="<?php echo $this->array[0]->tel?>">
       </div>
       <div class="form-group centrage col-md-3">
         <label for="inputmail">Adresse mail gérant</label>
         <input type="email" class="form-control formu1" id="inputmail" name="adrgerant" value="<?php echo $this->array[0]->adrgerant?>">
       </div>
       <div class="form-group centrage col-md-3">
         <label for="inputfax">Fax</label>
         <input type="tel" class="form-control formu1" id="inputfax" name="fax" value="<?php echo $this->array[0]->fax?>">
       </div>
       <div class="form-group centrage col-md-4">
         <label for="inputadresse">Adresse</label>
         <input type="text" class="form-control formu1" id="inputadresse" name="adress" value="<?php echo $this->array[0]->adress?>">
       </div>
     </div>
